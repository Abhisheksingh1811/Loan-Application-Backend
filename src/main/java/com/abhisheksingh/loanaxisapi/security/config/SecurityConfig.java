...
import com.abhisheksingh.loanaxisapi.feature.auth.service.CustomUserDetailsService;
import com.abhisheksingh.loanaxisapi.security.filter.JwtBlacklistFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/audit/login-history").authenticated()
